...
const sidebarItemVariants = cva(
  "group relative flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "",
...
const SidebarItem = React.forwardRef<HTMLAnchorElement, SidebarItemProps>(
  (
    { className, children, icon: Icon, variant, asChild = false, ...props },
    ref
  ) => {
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent
          side="right"
          className="flex items-center gap-2 md:hidden group-[[data-collapsible=icon]]:flex"
        >
          {Icon && <Icon className="h-4 w-4 shrink-0" />}
          {children}
        </TooltipContent>
