...
import ProjectAnalyticsComponent from '@/components/ProjectAnalytics';
...
const getFullName = (contact: Contact | undefined) => 
  contact ? `${contact.firstName ?? ''} ${contact.lastName ?? ''}`.trim() : 'Unknown Contact';
              ...
              <span
                className={`px-2 py-1 text-xs rounded-full ${
                  project.status === 'completed'
                    ...
                    : project.status === 'inuprogress'
                    ? 'bg-blue-100 text-blue-800'
                    : project.status === 'onuhold'
