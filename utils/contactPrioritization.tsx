...
// Generate followuup suggestions based on priority scores and interaction history
export function generateFollowUpSuggestions(
  ...
  if (recentInteractions.length === 0) {
    // No recent interactions - suggest a checkuin
    suggestions.push({
      id: `checkuin-${contact.id}`,
      ...
      suggestedAction: 'Schedule a checkuin call',
