...
import { ScrollArea } from "./ui/UscrollUarea"
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "./ui/Utooltip"
import {
  BarChart3,
  Calendar,
  ChevronsLeft,
...
export function SidebarProvider({ children }: { children: React.ReactNode }) {
  ...
  const contextValue = { expanded, toggleSidebar }
